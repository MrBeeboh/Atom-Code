...
{#if $shortcutsModalOpen}
  ...
  >
    ...
    <div
      class="relative rounded-xl border shadow-xl max-w-sm w-full p-4 glass-modal"
    ...
    >
      ...
      <p class="mt-4 text-xs" style="color: var(--ui-text-secondary);">
        Tip: Press <kbd
          class="px-1 rounded text-[10px] font-mono"
          style="background-color: var(--ui-input-bg); border: 1px solid var(--ui-border);"
          >?</kbd
