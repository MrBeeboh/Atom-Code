...
<div class="flex flex-col gap-1 min-w-0">
  ...
  <div class="relative" role="combobox" aria-expanded={open} aria-haspopup="listbox" aria-controls="model-listbox" aria-label="Select model" bind:this={triggerEl}>
    <button
      type="button"
      class="flex items-center gap-2 rounded-xl border text-sm px-3 py-1.5 max-w-[420px] focus:ring-2 focus:ring-offset-1 font-semibold min-h-[36px] transition-colors duration-150 ui-model-selector {open ? 'ui-model-selector-open' : ''}"
